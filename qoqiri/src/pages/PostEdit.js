...
import { getPlace, getPlaceType,getPlaceee, getEditPost, getPost, getMatchCate, getAttach,editPostAPI,editMatchingAPI,editAttachmentsAPI } from '../api/post';
...
const PostEdit = () => {
    ...
    const getPostAPI = async () => {
        ...
        // const getPlaceeeAPI = async()=>{
        //     const result = await getPlaceee(id);
        //     setPlace(result.data)
        //     const placeData = result.data
        //     setSelectedPlace(placeData.placeSeq);
        // }
    useEffect(() => {
        getPostAPI();
        selectCategoryAPI();
                    ...
                    <h3>{categoryType.ctName}</h3>
                        ...
                        <div id="postTitle" >
                            ...
                            <div className="edit-place-types">
                                ...
                                >
                                    {placeType?.map((placeType) => (
                                        <option key={placeType?.placeTypeSEQ} value={selectedPlace?.placeTypeSEQ}>
                            ...
                            <div className="edit-place">
                                ...
                                >
                                    {place?.map((place) => (
                                        <option key={place?.placeSeq} value={selectedPlace?.placeSeq}>
                                            {place?.placeName}
                                        </option>
                                    ))}
                                </select>
