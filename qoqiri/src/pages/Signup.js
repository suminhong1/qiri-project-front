...
const SignUp = () => {
    ...
    const onChangePassword = (e) => {
        ...
        if (!passwordRegExp.test(currentPassword)) {
            setPasswordMessage('숫자+영문자+특수문자 사용해서 8자리 이상 입력해주세요.');
            setIsPassword(false);
        } else {
            setPasswordMessage('');
            setIsPassword(true);
    ...
    const handleProfilePictureUpload = async (e) => {
        ...
        if (file) {
            try {
                ...
                const response = await axios.post('http://localhost:8080/qiri/uploadProfilePicture', formData, {
                    headers: {
            ...
            <div className="form-container">
                <div className="form">
                    ...
                    <div className="form-el">
                        ...
                        <input id="birth" name="birth" type="Date" value={birth} onChange={onChangeBirth} />
                    ...
                    <div className="form-el">
                        ...
                        <input id="age" name="age" type="number" value={age} onChange={onChangeAge} />
                    </div>
                    ...
                    <div className="form-el select-for-place">
                        ...
                        <select id="place" name="place" value={placeType.placeTypeName} onChange={handlePlaceChange}>
                            <option value="">선택하세요</option>
                            {placeTypes.map((placeType) => (
                                <option value={placeType.placeTypeName} key={placeType.placeTypeSEQ}>
                    ...
                    <div className="form-el select-for-mbti">
                        ...
                        <select id="mbti" name="mbti" type="String" value={mbti} onChange={handleMbtiChange}>
                            <option value="">선택하세요</option>
